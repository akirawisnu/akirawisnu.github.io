...
if(6===_getIEVer()&&'complete'!==document.readyState&&'object'===typeof document.attachEvent){document.attachEvent('onreadystatechange',function(e){if('complete'===document.readyState)window.setTimeout(initQueue,250);});}else{trackInitialVisibilityState();if(isDocumentHidden()){initQueueAfterDocumentIsVisible();}else{initQueue();}};return API;})();window.wpcom.tracks=(function(){var userId,userIdType,userLogin,previousAnonIds=[],retryTimeoutId=null,localCache={},context={},queriesPending={},pixel='//web.archive.org/web/20190415225358/https://pixel.wp.com/t.gif',cookieDomain=null,cookiePrefix='tk_',testCookie='tc',userAnonCookie='ai',userPrevAnonCookie='aip',queriesCookie='qs',queriesTTL=1800,clientUserIdType='wpcom:user_id';var TKQ=function(q){this.a=1;if(q&&q.length){for(var i=0;i<q.length;i++){this.push(q[i]);}}};TKQ.prototype.push=function(args){if(args){if("object"==typeof args&&args.length){var cmd=args.splice(0,1);if(API[cmd])API[cmd].apply(null,args);}else if("function"==typeof args){args();}}};var initQueue=function(){window._tkq=window._tkq||[];if(!window._tkq.a){retryQueries();window._tkq=new TKQ(window._tkq);}};var clone=function(obj,target){if(obj==null||'object'!==typeof obj)
...
/*
     FILE ARCHIVED ON 22:53:58 Apr 15, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:08:55 Aug 30, 2020.
...
/*
playback timings (ms):
  load_resource: 1974.244
  PetaboxLoader3.datanode: 1263.534 (8)
  exclusion.robots: 0.122
  RedisCDXSource: 739.097
  esindex: 0.015
  CDXLines.iter: 23.522 (3)
  exclusion.robots.policy: 0.11
  LoadShardBlock: 1432.277 (6)
  PetaboxLoader3.resolve: 1709.984 (3)
*/