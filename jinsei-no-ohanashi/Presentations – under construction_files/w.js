...
if(6===_getIEVer()&&'complete'!==document.readyState&&'object'===typeof document.attachEvent){document.attachEvent('onreadystatechange',function(e){if('complete'===document.readyState)window.setTimeout(initQueue,250);});}else{trackInitialVisibilityState();if(isDocumentHidden()){initQueueAfterDocumentIsVisible();}else{initQueue();}};return API;})();window.wpcom.tracks=(function(){var userId,userIdType,userLogin,previousAnonIds=[],retryTimeoutId=null,localCache={},context={},queriesPending={},pixel='//web.archive.org/web/20190416041102/https://pixel.wp.com/t.gif',cookieDomain=null,cookiePrefix='tk_',testCookie='tc',userAnonCookie='ai',userPrevAnonCookie='aip',queriesCookie='qs',queriesTTL=1800,clientUserIdType='wpcom:user_id';var TKQ=function(q){this.a=1;if(q&&q.length){for(var i=0;i<q.length;i++){this.push(q[i]);}}};TKQ.prototype.push=function(args){if(args){if("object"==typeof args&&args.length){var cmd=args.splice(0,1);if(API[cmd])API[cmd].apply(null,args);}else if("function"==typeof args){args();}}};var initQueue=function(){window._tkq=window._tkq||[];if(!window._tkq.a){retryQueries();window._tkq=new TKQ(window._tkq);}};var clone=function(obj,target){if(obj==null||'object'!==typeof obj)
...
/*
     FILE ARCHIVED ON 04:11:02 Apr 16, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:35:18 Aug 30, 2020.
...
/*
playback timings (ms):
  LoadShardBlock: 361.487 (6)
  PetaboxLoader3.datanode: 415.531 (8)
  RedisCDXSource: 4.058
  PetaboxLoader3.resolve: 262.336 (2)
  esindex: 0.019
  exclusion.robots: 0.3
  load_resource: 565.134
  CDXLines.iter: 40.249 (3)
