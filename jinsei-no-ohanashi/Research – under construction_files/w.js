...
if(6===_getIEVer()&&'complete'!==document.readyState&&'object'===typeof document.attachEvent){document.attachEvent('onreadystatechange',function(e){if('complete'===document.readyState)window.setTimeout(initQueue,250);});}else{trackInitialVisibilityState();if(isDocumentHidden()){initQueueAfterDocumentIsVisible();}else{initQueue();}};return API;})();window.wpcom.tracks=(function(){var userId,userIdType,userLogin,previousAnonIds=[],retryTimeoutId=null,localCache={},context={},queriesPending={},pixel='//web.archive.org/web/20190415212942/https://pixel.wp.com/t.gif',cookieDomain=null,cookiePrefix='tk_',testCookie='tc',userAnonCookie='ai',userPrevAnonCookie='aip',queriesCookie='qs',queriesTTL=1800,clientUserIdType='wpcom:user_id';var TKQ=function(q){this.a=1;if(q&&q.length){for(var i=0;i<q.length;i++){this.push(q[i]);}}};TKQ.prototype.push=function(args){if(args){if("object"==typeof args&&args.length){var cmd=args.splice(0,1);if(API[cmd])API[cmd].apply(null,args);}else if("function"==typeof args){args();}}};var initQueue=function(){window._tkq=window._tkq||[];if(!window._tkq.a){retryQueries();window._tkq=new TKQ(window._tkq);}};var clone=function(obj,target){if(obj==null||'object'!==typeof obj)
...
/*
     FILE ARCHIVED ON 21:29:42 Apr 15, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:38:57 Aug 30, 2020.
...
/*
playback timings (ms):
  PetaboxLoader3.datanode: 2090.21 (8)
  CDXLines.iter: 15.993 (3)
  esindex: 0.012
  exclusion.robots.policy: 0.119
  exclusion.robots: 0.131
  load_resource: 2463.111
  RedisCDXSource: 40.646
  PetaboxLoader3.resolve: 277.2 (3)
  LoadShardBlock: 612.106 (6)
*/